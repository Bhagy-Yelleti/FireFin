  ...
  if (spendingByCategory.length === 0) {
    return (
      <Card className="h-full">
        ...
        <EmptyState title="No expenses" description="No expense data available yet." />
      </Card>
    );
  }
        ...
        <div className="grid content-start gap-3">
          {spendingByCategory.map((item) => {
            ...
            return (
              <div
                key={item.name}
                className="rounded-2xl border border-slate-200 bg-slate-50 p-3.5 dark:border-slate-700 dark:bg-slate-900/60"
              >
